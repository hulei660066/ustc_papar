...
\newblock {\em Improving web search ranking by incorporating user behavior information}.
\newblock Proc. SIGIR, 19-26.

\bibitem{user-interests-explore1}
Bilenko, M. et al. (2008).
\newblock {\em Talking the talk vs. walking the walk: salience of information needs in querying vs. browsing}.
\newblock Proc. ACM SIGIR, 705-706.

\bibitem{user-interests-explore2}
Broder, A. (2002).
\newblock {\em A taxonomy of Web search}.
...
\newblock {\em  Watson: anticipating and contextualizing information needs}.
...
\newblock {\em Video suggestion and discovery for youtube: taking random walks through the view graph}.
...
\bibitem{recmd_content_based}
周涛.2011.
\newblock {\em 基于内容的推荐算法}.
...
Adams, Suellen .2005.
\newblock {\em Information Behavior and the Formation and Maintenance of Peer Cultures in Massive Multiplayer Online Roleplaying Games: a Case Study of City of Heroes}.
...
\newblock {\em Understanding the Identity Concept in the Context of Digital Social Environments}.
\newblock FIDIS Deliverables. 2. FIDIS. pp. 74–91.

\bibitem{user-profile2}
Suler, John (2004).
\newblock {\em The Online Disinhibition Effect}.
\newblock CyberPsychology \& Behavior. 7 (3): 321–326.

\bibitem{user-profile3}
Marcus, Bernd; Machilek, Franz; Schütz, Astrid (2006).
\newblock {\em Personality in cyberspace: Personal web sites as media for personality expressions and impressions}.
\newblock Journal of Personality and Social Psychology. 90 (6): 1014–1031.

\bibitem{user-profile4}
Siibak, Andra (September 2007).
\newblock {\em  Casanovas of the Virtual World. How Boys Present Themselves on Dating Websites}.
...
\newblock {\em Towards the Next Generation of Recommender Systems: A Survey of the State-of-the-Art and Possible Extensions}.
\newblock  IEEE transactions on knowledge and data engineering, vol. 17, no. 6.

\bibitem{Wikipedia}
From Wikipedia, the free encyclopedia.
\newblock {\em Collaborative filtering}.
