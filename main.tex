...
\else
	...
	%%%%%%%%%%%%%%%%%
	% 摘要
	 \include{chapter/0chap-abstract}%此文件中含有中英文摘要
	% 目录
	\tableofcontents
	%默认表格、插图、算法索引名称分别为“表格索引”、“插图索引”和“算法索引”
	%如果需要自行修改lot，lof，loa的名称，请定义
...
\mainmatter
   ...
   \include{chapter/1chap-intro}
   \include{chapter/2chap-guide}
   \include{chapter/3chap-unify}
   \include{chapter/4chap-userProfile}
  %自行添加
  \include{chapter/5chap-userExplore}
  \include{chapter/6chap-summary}
